...
### Section 3.1 - Initializing MobilNetV2

```{python}
#Fetch network from keras, & define custom params. 
# This is a pre-trained model,bbut we remove the last layer 
...
# Make sure exsiting layers (convolutionary & pooling) remain untouched
